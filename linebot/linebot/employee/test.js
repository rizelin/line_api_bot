...
$('.company_select').change(function(){
  ...
  // 임시
  var index2 = $('.affiliation_select option:selected').val();
...
// // 주간 스케줄 폼 셀렉트로 보여주기
// $('.form_select_radio').change(function(){
//     var index2 = $('.form_select_radio option:selected').val(); //선택된옵션밸류
//     $('.from_select'+index2).css('display','block'); //선택된 회사의 부서만 보이게
//     $('.employee_name_default').prop('selected',true);
//     for (var i = 0; i < cn2.length; i++) {
//         if (cn2[i] != 'employee_name'+index2) {  //선택된 부서와 다른 class명일 때 숨김
//             $('.'+cn2[i]).css('display','none');
