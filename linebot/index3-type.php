...
// $httpClient = new \LINE\LINEBot\HTTPClient\CurlHTTPClient('L3z1Lzo3B/U2WwL7Rh8t2YGplwDUuXhdUNS17TVe87KrwpV7Kg0m8xoyqdK5UOUcZVirrtpMxfdiMkAKiZvLaQscjmUF6rAXy/dUCaePOJq3Acia4Dmb5Epuo+zGkE/oFur/X51Unild58zAK9N9SQdB04t89/1O/w1cDnyilFU=');
// $bot = new \LINE\LINEBot($httpClient, ['channelSecret' => 'dc8a768e8c382978a43b9cefcdb801f8']);
...
// 유저가 대답한 워드를 수집
$message_text = "type : {$event['source']['type']} {$type} userId : {$event['source']['userId']}";
